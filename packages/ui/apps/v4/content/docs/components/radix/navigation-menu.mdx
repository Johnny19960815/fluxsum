...
{/* <ComponentPreview styleName="new-york-v4" name="navigation-menu-rtl" direction="rtl" previewClassName="h-96" className="overflow-visible" /> */}

## API 参考

更多信息请参阅 [Radix UI Navigation Menu](https://www.radix-ui.com/docs/primitives/components/navigation-menu#api-reference) 文档。
