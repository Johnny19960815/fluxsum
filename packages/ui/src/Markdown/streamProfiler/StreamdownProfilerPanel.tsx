...
const panelStyle: CSSProperties = {
  background: 'var(--flxsum-color-bg-container)',
  border: '1px solid var(--flxsum-color-border)',
  borderRadius: 16,
  display: 'flex',
...
const eyebrowStyle: CSSProperties = {
  color: 'var(--flxsum-color-text-secondary)',
  fontSize: 12,
  fontWeight: 600,
...
const tableCellStyle: CSSProperties = {
  borderBottom: '1px solid var(--flxsum-color-border-secondary)',
  padding: '6px 0',
  textAlign: 'left',
  verticalAlign: 'top',
};
...
const FpsSparkline = ({ samples, targetFps }: { samples: number[]; targetFps: number }) => {
  ...
  return (
    <div style={chartFrameStyle}>
      ...
      >
        <line
          stroke={'var(--flxsum-color-border)'}
          strokeDasharray={'4 4'}
          strokeWidth={1}
          x1={0}
          x2={width}
        ...
        <polyline
          fill={'none'}
          points={points}
          stroke={'var(--flxsum-color-primary)'}
          strokeLinecap={'round'}
