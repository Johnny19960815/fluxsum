  ...
  ({
    ...
    const popupStyle = useMemo(() => {
      ...
      const baseStyle: React.CSSProperties = {
        ...
        ['--flxsum-select-popup-max-height' as any]: maxHeight,
      };
    ...
    const virtualListStyle = useMemo(() => {
      ...
      return {
        height: `min(${estimatedHeight}px, var(--flxsum-select-available-height, var(--available-height)))`,
      };
