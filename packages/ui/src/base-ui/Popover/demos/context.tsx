import { Button, Flexbox, Popover, Tag, usePopoverContext } from '@fluxsum/ui';
...
const Content = () => {
  ...
  return (
    <Flexbox gap={16} style={{ padding: '12px 16px', width: 320 }}>
      <Flexbox gap={10}>
        <Flexbox horizontal align="center" gap={8}>
          <Flexbox
            ...
            justify="center"
            style={{
              background: 'var(--flxsum-color-success-bg)',
              borderRadius: 8,
              height: 36,
              width: 36,
            }}
          >
            <Code2 size={18} style={{ color: 'var(--flxsum-color-success)' }} />
          </Flexbox>
        ...
        <div style={{ color: 'var(--flxsum-color-text-2)', fontSize: 13, lineHeight: 1.7 }}>
      ...
      >
        <div style={{ color: 'var(--flxsum-color-text-3)' }}>
          const {'{ close }'} = usePopoverContext();
        </div>
      </Flexbox>
