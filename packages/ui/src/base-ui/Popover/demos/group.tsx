import { Button, Flexbox, Popover, PopoverGroup, Tag } from '@fluxsum/ui';
...
const content = {
  analytics: (
    <Flexbox gap={10} style={{ padding: '8px 12px', width: 280 }}>
      <Flexbox horizontal align="center" gap={8}>
        <BarChart3 size={18} style={{ color: 'var(--flxsum-color-primary)' }} />
        <div style={{ fontSize: 15, fontWeight: 600 }}>Analytics</div>
        <Tag color="green">Popular</Tag>
      </Flexbox>
      <div style={{ color: 'var(--flxsum-color-text-2)', fontSize: 13, lineHeight: 1.6 }}>
  ...
  automation: (
    <Flexbox gap={10} style={{ padding: '8px 12px', width: 260 }}>
      <Flexbox horizontal align="center" gap={8}>
        <Sparkles size={18} style={{ color: 'var(--flxsum-color-warning)' }} />
  ...
  dashboard: (
    <Flexbox gap={10} style={{ padding: '8px 12px', width: 280 }}>
      <Flexbox horizontal align="center" gap={8}>
        <LayoutDashboard size={18} style={{ color: 'var(--flxsum-color-success)' }} />
...
export default () => (
  <PopoverGroup contentLayoutAnimation>
    <Flexbox
      ...
      gap={4}
      style={{
        background: 'var(--flxsum-color-fill-secondary)',
        borderRadius: 12,
        padding: '8px 12px',
        width: 'fit-content',
      }}
