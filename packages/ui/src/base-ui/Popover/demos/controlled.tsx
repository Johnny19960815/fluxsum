import { ActionIcon, Button, Flexbox, Input, Popover, Tag } from '@fluxsum/ui';
            ...
            <Flexbox gap={16} style={{ padding: '12px 16px', width: 280 }}>
              <Flexbox horizontal align="center" gap={12}>
                <Flexbox
                  ...
                  justify="center"
                  style={{
                    background: 'var(--flxsum-color-error-bg)',
                    borderRadius: 8,
                    height: 40,
                    width: 40,
                  }}
                >
                  <AlertTriangle size={20} style={{ color: 'var(--flxsum-color-error)' }} />
                </Flexbox>
                <Flexbox flex={1} gap={6}>
                  <div style={{ fontSize: 15, fontWeight: 600 }}>Confirm Deletion</div>
                  <div style={{ color: 'var(--flxsum-color-text-3)', fontSize: 12 }}>
          ...
          content={
            <Flexbox gap={16} style={{ padding: '12px 16px', width: 300 }}>
              <Flexbox horizontal align="center" gap={8}>
                <Edit3 size={18} style={{ color: 'var(--flxsum-color-primary)' }} />
