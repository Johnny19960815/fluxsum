import { Button, Flexbox, Popover, type PopoverProps, Tag } from '@fluxsum/ui';
    ...
    <StoryBook levaStore={store}>
      <Flexbox align="center" gap={16}>
        <Flexbox horizontal align="center" gap={12}>
          <Sliders size={20} style={{ color: 'var(--flxsum-color-primary)' }} />
          <div style={{ fontSize: 15, fontWeight: 600 }}>Interactive Playground</div>
          <Tag color="blue">Customizable</Tag>
        </Flexbox>
        <div style={{ color: 'var(--flxsum-color-text-3)', fontSize: 13 }}>
