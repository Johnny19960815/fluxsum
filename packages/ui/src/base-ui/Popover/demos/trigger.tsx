...
export default () => {
  return (
    <Header
      logo={<span style={{ fontWeight: 700 }}>Fluxsum</span>}
      actions={
          ...
          <Flexbox horizontal align="center" gap={12}>
                ...
                <Flexbox gap={12} style={{ padding: '12px', width: 340 }}>
                  <Flexbox horizontal align="center" justify="space-between">
                    <Flexbox horizontal align="center" gap={8}>
                      <Bell size={18} style={{ color: 'var(--flxsum-color-primary)' }} />
                  ...
                  <Flexbox gap={8}>
                    {[
                      ...
                      <Flexbox
                        ...
                        key={i}
                        style={{
                          background: 'var(--flxsum-color-fill-tertiary)',
                          borderRadius: 10,
                          cursor: 'pointer',
                          padding: '12px 14px',
                          transition: 'all 0.2s',
                      ...
                      >
                        ...
                        <div style={{ color: 'var(--flxsum-color-text-3)', fontSize: 11 }}>
                          {item.time}
                        </div>
                      </Flexbox>
                    ))}
            ...
            >
              <div style={{ position: 'relative' }}>
                ...
                <div
                  style={{
                    background: 'var(--flxsum-color-error)',
                    borderRadius: '50%',
                    height: 8,
                    position: 'absolute',
                    right: 8,
              ...
              content={
                <Flexbox gap={8} style={{ padding: '8px', width: 240 }}>
                  <Flexbox
                    ...
                    style={{
                      background:
                        'linear-gradient(135deg, var(--flxsum-color-fill-secondary) 0%, var(--flxsum-color-fill-tertiary) 100%)',
                      borderRadius: 10,
                      padding: '12px 14px',
                    }}
                  >
                    <Avatar
                      ...
                      size={44}
                      style={{ border: '2px solid var(--flxsum-color-bg-container)' }}
                    />
                  ...
                  <div
                    style={{
                      background: 'var(--flxsum-color-border)',
                      height: 1,
                      margin: '4px 0',
                    }}
                  />
            ...
            >
              <Avatar
                ...
                size={36}
                style={{
                  border: '2px solid var(--flxsum-color-border)',
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                }}
              />
