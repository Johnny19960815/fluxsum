import { ActionIcon, Button, DropdownMenu, Flexbox, Popover, Tag } from '@fluxsum/ui';
          ...
          <Flexbox gap={16} style={{ padding: '12px 16px', width: 300 }}>
            <Flexbox horizontal align="center" justify="space-between">
              <Flexbox horizontal align="center" gap={8}>
                <Folder size={18} style={{ color: 'var(--flxsum-color-primary)' }} />
            ...
            >
              ...
              <div style={{ color: 'var(--flxsum-color-text-3)', fontSize: 12, lineHeight: 1.6 }}>
