...
```tsx
import { ColorScales, primary } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, red } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, volcano } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, orange } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, gold } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, yellow } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, lime } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, green } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, cyan } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, blue } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, geekblue } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, purple } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, magenta } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, gray } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, mauve } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, olive } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, sage } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, sand } from '@fluxsum/ui/color';
...
```tsx
import { ColorScales, slate } from '@fluxsum/ui/color';
