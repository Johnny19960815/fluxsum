...
import { FLXSUM_THEME_APP_ID } from './constants';
...
const ThemeProvider = memo<ThemeProviderProps>(
  ({
    ...
    const webfontUrls = useMemo(
      () =>
        customFonts || [
          genCdnUrl({ path: 'css/index.css', pkg: '@flxsum/webfont-mono' }),
          genCdnUrl({
            path: 'css/index.css',
            pkg: '@flxsum/webfont-harmony-sans',
          }),
          genCdnUrl({
            path: 'css/index.css',
            pkg: '@flxsum/webfont-harmony-sans-sc',
          }),
      ...
      <>
        ...
        >
          <AntdConfigProvider>
            ...
            >
              <div id={FLXSUM_THEME_APP_ID} ref={setAppRef} style={{ display: 'contents' }}>
